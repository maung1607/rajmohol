                ...
                <div class="col-md-8 mx-auto">
                    <div class="my-2">
                        ...
                        <div class="alert alert-success alert-dismissible show fade">
                            ...
                            <form action="{{ route('room.update',['id'=>$roomInfo->id]) }}" method="POST">
                                @csrf
                                <div class="row">
                                    <!-- Left Column -->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="room_number" type="text" name="room_number" class="form-control" placeholder="Enter room number" value="{{ $roomInfo->room_number??old('room_number') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="room_class_id" id="room_class_id" class="form-control">
                                                ...
                                                <option value="{{ $roomClass->id }}" {{ $roomInfo->room_class->id??old('room_class_id') == $roomClass->id ? 'selected' : '' }}>
                                                    {{ $roomClass->name }}
                                                </option>
                                                @endforeach
                                            </select>
